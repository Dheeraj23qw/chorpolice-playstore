...
const ChorPoliceResult = () => {
  ...
  return (
    <View className="flex-1 bg-[#09090b]">
      ...
      <View 
        style={{ width: wp(110), height: wp(110), top: -hp(10), right: -wp(20) }} 
        className="absolute bg-indigo-600/10 rounded-full blur-[120px]" 
      />
      <View 
        style={{ width: wp(100), height: wp(100), bottom: -hp(15), left: -wp(20) }} 
      ...
      {isDynamicPopUp && winnerImage && winnerPlayerImageType ? (
        ...
        >
          ...
          <View className="px-6 py-4">
            <Text style={{ fontSize: rf(1.2) }} className="text-white/30 font-black uppercase tracking-[5px]">
              Final Briefing
            </Text>
            <Text style={{ fontSize: rf(3.5) }} className="text-white font-black italic -mt-1">
              RESULTS
            </Text>
          </View>
            ...
            <View className="px-6 mb-8">
              <View className="bg-white/[0.03] border border-white/10 rounded-[32px] p-4">
                <View className="flex-row items-center mb-4 px-2">
                   ...
                   <Text style={{ fontSize: rf(1) }} className="text-white/40 font-bold uppercase tracking-widest">
                     Squad Rankings
                   </Text>
                </View>
                <MemoizedLeaderboard
