...
export const FullScreenMenu = ({ visible, onClose, router }: any) => {
  ...
  const menuItems = [
    { label: "Earn", icon: "flash-outline", path: "/earn" },
    ...
    { label: "Bugs", icon: "bug-outline", path: "/bug" },
  ...
  return (
    <Modal transparent visible={visible} animationType="none">
      <View className="flex-1 items-center justify-center">
        ...
        {/* Main Card */}
        <Animated.View
          entering={ZoomIn.springify().damping(25)}
        ...
        >
          ...
          <View className="px-6 py-5 border-b border-[#d4af372e] flex-row items-center justify-between bg-white/5">
            ...
            <Pressable
              onPress={onClose}
              className="bg-[#d4af372e] active:bg-[#d4af3759] rounded-xl p-2"
            >
          ...
          <Animated.ScrollView
            ...
            onContentSizeChange={(_, h) =>
              setCanScroll(h > (isTablet ? 600 : 500))
            }
          ...
          >
            <View className="flex-row flex-wrap justify-between">
              {menuItems.map((item, index) => (
                ...
                >
                  <View className="bg-[#37d44c1a] p-2 rounded-xl mb-1">
                    <Ionicons
                  ...
                  <Text
                    numberOfLines={1}
                    className="text-white text-[11px] lg:text-[14px] font-bold text-center px-1"
                  >
                    {item.label}
                  </Text>
                </Pressable>
