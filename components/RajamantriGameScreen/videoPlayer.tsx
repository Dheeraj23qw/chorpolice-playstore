...
const VIDEO_SOURCES: Record<number, any> = {
  ...
  2: require('../../assets/gif/chorPolicescreen/police.mp4'),
  3: require('../../assets/gif/chorPolicescreen/chor.mp4'),
  // 4: require('../../assets/gif/quiz/laugh.mp4'),
  // 5: require('../../assets/gif/quiz/weep.mp4'),
...
const VideoPlayerComponent: React.FC<VideoPlayerComponentProps> = memo(({ videoIndex, onVideoEnd }) => {
