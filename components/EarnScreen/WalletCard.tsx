      ...
      <View className="flex-row items-center justify-between">
        <View>
          ...
          <View className="flex-row items-baseline">
            ...
            <Text className="ml-2 text-4xl font-main-bold text-indigo-200 tracking-tighter">
              🪙
            </Text>
          </View>
        </View>
        ...
        <View className="h-16 w-16 items-center justify-center rounded-[24px] bg-white/20 border border-white/30 shadow-lg">
