    ...
    <View className="w-full py-6">
      ...
      {selectedImages.length > 0 && (
        <View className="flex-row items-end mb-6 px-4">
          ...
          <View>
            <Text className="text-indigo-400 text-[10px] font-main-md uppercase tracking-[3px]">
              Squad Manifest
            </Text>
            <Text
              style={{ fontSize: rf(1.6) }}
              className="text-white font-main-bold uppercase  tracking-tighter"
            >
              Elite Strike Team
            </Text>
          </View>
            ...
            return (
              ...
              >
                ...
                <View className="relative">
                  ...
                  {/* Status Badge */}
                  <View
                    className={`absolute -bottom-1 -right-1 w-6 h-6 rounded-full items-center justify-center border-2 border-[#020205] ${hasName ? "bg-indigo-500" : "bg-white/20"}`}
                  >
                    <View
                      className={`w-1.5 h-1.5 rounded-full ${hasName ? "bg-white" : "bg-white/40"}`}
                    />
                  </View>
                </View>
                ...
                <View className="mt-5 w-full bg-white/[0.03] border-b border-white/10 rounded-t-lg px-2">
                  <TextInput
                    className="text-white font-main-md text-center py-2"
