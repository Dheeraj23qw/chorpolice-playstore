...
> = {
  EN: {
    ...
    items: [
      {
        title: "Quiz Table",
        desc: "Always consult the Quiz Table to find the correct answer before selecting.",
        icon: "calculator-outline",
        color: "#818cf8",
      },
      {
        title: "Timer",
        desc: "Each question has a time limit. Answer before the timer runs out.",
        icon: "time-outline",
        color: "#facc15",
      },
      {
        title: "Answer Options",
        desc: "Choose from 4 options. Only one answer is correct.",
        icon: "list-outline",
        color: "#22c55e",
      },
      {
        title: "50 / 50 Lifeline",
        desc: "Use the 50-50 button to eliminate 2 wrong options and increase your chances.",
        icon: "help-circle-outline",
        color: "#fb7185",
      },
      {
        title: "Narration",
        desc: "Questions can be narrated aloud. Use the speaker button to listen.",
        icon: "volume-high-outline",
        color: "#a78bfa",
      },
      {
        title: "Scoring",
        desc: "Correct answers earn points. Faster answers score higher.",
        icon: "trophy-outline",
        color: "#f59e0b",
      },
    ],
  ...
  HI: {
    ...
    items: [
      {
        title: "Quiz Table",
        desc: "Answer select karne se pehle hamesha Quiz Table dekhein.",
        icon: "calculator-outline",
        color: "#818cf8",
      },
      {
        title: "Timer",
        desc: "Har question ke liye time limit hota hai. Timer khatam hone se pehle answer dein.",
        icon: "time-outline",
        color: "#facc15",
      },
      {
        title: "Answer Options",
        desc: "4 options me se choose karein. Sirf ek answer sahi hota hai.",
        icon: "list-outline",
        color: "#22c55e",
      },
      {
        title: "50 / 50 Lifeline",
        desc: "50-50 button use karke 2 galat options ko remove kar sakte hain.",
        icon: "help-circle-outline",
        color: "#fb7185",
      },
      {
        title: "Narration",
        desc: "Questions audio me bhi sunai deti hain. Speaker button use karke sunen.",
        icon: "volume-high-outline",
        color: "#a78bfa",
      },
      {
        title: "Scoring",
        desc: "Sahi answer se points milte hain. Jaldi answer dene se zyada points.",
        icon: "trophy-outline",
        color: "#f59e0b",
      },
    ],
