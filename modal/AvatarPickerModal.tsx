...
export const AvatarPickerModal: React.FC<AvatarPickerModalProps> = ({
  visible,
  editingPlayerName = "Select Avatar",
  subtitleText = "Pick an avatar. If another player already has it, the two avatars will swap.",
  selectedAvatarIds,
  isAvatarTaken,
  onClose,
  onSelect,
          ...
          <View className="mt-auto flex-1">
            ...
            <View className="flex-1 px-2 pb-5">
              <ImageGrid
                ...
                gameMode={gameMode}
                isTaken={(id: number) => (isAvatarTaken ? isAvatarTaken(id) : false)}
              />
            </View>
          </View>
        </MotiView>
